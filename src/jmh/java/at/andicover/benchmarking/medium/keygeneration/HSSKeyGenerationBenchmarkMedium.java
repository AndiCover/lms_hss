package at.andicover.benchmarking.medium.keygeneration;
...
@Warmup(iterations = 5, time = 20, timeUnit = TimeUnit.NANOSECONDS)
@Measurement(iterations = 5, time = 20, timeUnit = TimeUnit.NANOSECONDS)
@Fork(1)
@Timeout(time = 3, timeUnit = TimeUnit.HOURS)
public class HSSKeyGenerationBenchmarkMedium {
